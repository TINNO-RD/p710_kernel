...
static ulong ramoops_console_size = 256*1024UL;   //odm add for pstore
...
static unsigned long long mem_address=0x9df00000; //odm add for pstore
module_param_hw(mem_address, ullong, other, 0400);
MODULE_PARM_DESC(mem_address,
		"start of reserved RAM used to store oops/panic logs");

//static ulong mem_size;
static ulong mem_size=0x100000;  //odm add for pstore
