...
#ifdef JOURNEY_FEATURE_SOLVE_SYSTEM_BUG
    /*
    CJ: Monkey want to use procprok to read oom_score_adj
        but it have Permission denied. monkey Did not deal with this situation.
        it will cause monkey wait procprok, and procprok wait for stderr output pipe
        here is just change S_IRUSR to S_IRUGO , I have confirmed with MTK baseline that it can be changed like this.
    */
