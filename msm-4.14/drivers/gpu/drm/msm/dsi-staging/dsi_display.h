...
/*
dsi_display_req_hbm     : call by sdm (android.hardware.graphics.composer)
dsi_display_set_hbm     : call by dsi_display_update_hbm
dsi_display_update_hbm  : call by dsi_conn_post_kickoff
*/

/**
 * dsi_display_set_hbm() - enable/disable hbm
 * @connector:          Pointer to drm connector structure
 * @display:            Handle to display.
 * @hbm_enable:         1: enable, 0: disable(set the user brightness which before enable hbm).
 */
...
void dsi_display_update_hbm(void *dsi_display, int allow_hbm);
