...
struct qpnp_qg {
	...
	int			adj_last_msoc;
	int			adj_this_msoc;
	struct work_struct	update_adj_msoc_work;
	struct alarm		alarm_timer_adjust_msoc;
	struct work_struct	update_adj_msoc_full_work;
	struct alarm		alarm_timer_adjust_msoc_full;
	#endif
	int			pon_soc;
	int			batt_soc;
	int			cc_soc;
...
enum debug_mask {
	...
	QG_DEBUG_ESR		= BIT(11),
	QG_DEBUG_CUSTOM 	= BIT(12),			//for custom debug date20200326
};
