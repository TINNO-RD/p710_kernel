...
#define SPEED_DAEMON_VOTER		"SPEED_DAEMON_VOTER"			//pony.ma for scc date20200618
#endif
...
#define THERMAL_ICL_MAX_VOTER		"THERMAL_ICL_MAX_VOTER"		//usb_icl for thermal by pony date20200925
...
//for scc by pony start date20200618
#ifdef CONFIG_SCC_SUPPORT
int smblib_set_prop_speed_level(struct smb_charger *chg,
				int scc_speed);
#endif
