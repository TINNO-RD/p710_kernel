...
struct goodix_ts_device *g_ts_dev;
static int get_tp_fw_info(char *buf, void *arg0) 
{
    return sprintf(buf, 
        "BOE-P710-GT9886-V%02X%02X%02X%02X-%d",
        g_ts_dev->chip_version.vid[0], g_ts_dev->chip_version.vid[1],
        g_ts_dev->chip_version.vid[2], g_ts_dev->chip_version.vid[3],
        g_ts_dev->normal_cfg.data[0]);
}
#endif
